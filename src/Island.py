...
class Island:
	def __init__(self, pin, representation, selection, migration, replacement, reproduction, population_size, tmp_dir):
		...
		self.evaluator = 'eval/' + representation.attrib['evaluator'] + '/code.py'
	...
	def print_generation_summary(self):
		print(self.pin, 'fittest', self.individuals[0].fitness, 'mean', self.average_fitness, 'generation', self.generation)
